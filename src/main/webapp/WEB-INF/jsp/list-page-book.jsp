...
<body>
	...
	<div class="wrapper">
        ...
        <div class="container">
            <h1 class="pull-left">七年级上册</h1>
            <ul class="pull-right breadcrumb">
           
                <li><a href="/index.html">首页</a></li>
				<li><a href="javascript:void(0)">七年级上册</a></li>
            </ul>
        </div>
    </div>
		<!--=== End Breadcrumbs ===-->
								...
								<div class="thumbnails thumbnail-style thumbnail-kenburn">
									<div class="thumbnail-img">
										<div class="overflow-hidden">
											<img class="img-responsive" src="http://chuantu.biz/t6/51/1505630339x1780904736.jpg" alt="">
										</div>
										<a class="btn-more hover-effect" href="/lesson/grade7/book1/cover.html">观看视频 +</a>
									</div>
									<div class="caption">
										<h3>
											<a class="hover-effect" href="/lesson/grade7/book1/cover.html">封面</a>
										</h3>
										<p>七年级上册封面视频</p>
									</div>
								</div>
							...
							<div class="col-md-3 col-sm-6">
								<div class="thumbnails thumbnail-style thumbnail-kenburn">
									<div class="thumbnail-img">
										...
										<a class="btn-more hover-effect" href="/lesson/grade7/book1/chapter${i}.html">观看视频 +</a>
									</div>
									<div class="caption">
										<h3>
											<a class="hover-effect" href="/lesson/grade7/book1/chapter${i}.html">第${i}课</a>
										</h3>
										<p>七年级上册第${i}课</p>
									</div>
								</div>
