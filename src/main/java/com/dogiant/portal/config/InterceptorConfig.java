...
import com.dogiant.portal.web.interceptor.LoginInterceptor;
...
public class InterceptorConfig extends WebMvcConfigurerAdapter {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		registry.addInterceptor(new LoginInterceptor()).addPathPatterns("/user/**").excludePathPatterns("/assets/**","/login**","/api/login**", "/**/*.html");
