package com.dogiant.portal.web.interceptor;
...
import com.dogiant.portal.cookie.CookieUtil;
import com.dogiant.portal.cookie.UserInfo;
...
public class LoginInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if (userInfoMap != null) {
			UserInfo userInfo = (UserInfo) userInfoMap.get("user");
