package com.dogiant.portal.cookie;
...
public class CookieUtil {
	...
	public static boolean setUserCookie(HttpServletResponse response, UserInfo user, String ticket) {
	...
	public static boolean setUserCookie(HttpServletResponse response, UserInfo user, int second, String ticket) {
		String cookieValue = CookieUtil.generateCookieValue(user, ticket);
		return cookieValue != null && CookieUtil.setCookie(response, COOKIE_KEY, cookieValue, second);
	}

	private static String generateCookieValue(UserInfo user, String ticket) {
